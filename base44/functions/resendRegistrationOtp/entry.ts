  ...
  const res = await fetch('https://api.postmarkapp.com/email', {
    ...
    body: JSON.stringify({
      ...
      HtmlBody: renderBrandedEmail({
        ...
        intro: 'here is a fresh verification code to confirm your email and continue your north scale registration. this code expires in 10 minutes.',
        code,
...
Deno.serve(async (req) => {
  try {
    ...
    console.error('resendRegistrationOtp error:', error.message);
